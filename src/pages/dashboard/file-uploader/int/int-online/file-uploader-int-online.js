...
function FileUploaderIntOnline() {
    ...
    return (
        <div className="bg-white dark:bg-black p-6 h-full">
            <h3 className="rounded-md from-indigo-500 via-purple-500 to-pink-500 border border-white p-2 bg-gradient-to-r block font-bold w-full text-gray dark:text-white mb-3">File Uploader Int Online</h3>
...
export default FileUploaderIntOnline;

export async function uploadActionIntOnline({request}) {
