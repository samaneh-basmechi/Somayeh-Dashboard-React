...
function FileUploaderDevOnline() {
    ...
    return (
        <div className="bg-white dark:bg-black p-6 ">
            <h3 className="block font-bold w-full text-gray dark:text-white mb-3">File Uploader Dev Online</h3>
...
export default FileUploaderDevOnline;
...
export async function uploadAction({request}) {
    ...
    const response = await httpService.post('api/document', data, config);
