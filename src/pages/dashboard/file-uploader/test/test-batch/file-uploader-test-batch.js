...
function FileUploaderTestBatch() {
    ...
    return (
        <div className="bg-white dark:bg-black p-6 h-full">
            <h3 className="rounded-md from-indigo-500 via-purple-500 to-pink-500 border border-white p-2 bg-gradient-to-r block font-bold w-full text-gray dark:text-white mb-3">File Uploader Test Batch</h3>
                ...
                <div
                    ...
                    <Form onSubmit={handleSubmit(onSubmit)} className="flex flex-col h-[100%] gap-3">
                        ...
                        <div className="flex gap-3">
                            {/*Vearbeitungstype*/}
                            <BatchProcessType register={register} errors={errors}/>
                            {/*Dokumentenart*/}
...
export default FileUploaderTestBatch;

export async function uploadActionTestBatch({request}) {
