    ...
    <div className="relative inline-block text-left">
      ...
      <div
        className={`absolute right-0 z-10 mt-2 w-56 origin-top-right 
         rounded-md dark:bg-gray-800 bg-white shadow-lg ring-1 ring-black
          ring-opacity-5 focus:outline-none ${!show ? 'hidden' : undefined}`}
        ref={ref}
        role="menu" aria-orientation="vertical"
        aria-labelledby="menu-button" tabIndex="-1">
        <div className="py-1">
          <a
            className="hover:bg-gray-400 dark:text-white text-gray-700 block px-4 py-2 text-sm flex gap-3 cursor-pointer"
            onClick={() => {
              changeLanguage('en');
              setShow(false);
            }}
